<script lang="ts">
	...
	const commonClasses = `glass-badge relative inline-flex items-center justify-center overflow-hidden rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium text-white shadow-md backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:shadow-lg`;
</script>
...
>
	<div
		...
		style="background: radial-gradient(300px circle at {x}px {y}px, rgba(255,255,255,0.2), transparent 40%);"
	></div>
